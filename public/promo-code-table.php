        ...
        <form method="post" id="add_form" action="public/db-operation.php">
          ...
          <div class="box-body">
            <div class="form-group col-md-6">
              <label for="">Promo Code</label><i class="text-danger asterik">*</i>
              <input type="text" class="form-control" name="promo_code">
            </div>
            <div class="form-group col-md-6">
              <label for="">Message</label><i class="text-danger asterik">*</i>
              <input type="text" class="form-control" name="message">
            </div>
            <div class="form-group col-md-6">
              <label for="">Start Date</label><i class="text-danger asterik">*</i>
              <input type="date" class="form-control" name="start_date" id="start_date">
            </div>
            <div class="form-group col-md-6">
              <label for="">End Date</label><i class="text-danger asterik">*</i>
              <input type="date" class="form-control" name="end_date" id="end_date">
            </div>
            <div class="form-group col-md-6">
              <label for="">No. Of Users</label><i class="text-danger asterik">*</i>
              <input type="number" class="form-control" name="no_of_users">
            </div>
            <div class="form-group col-md-6">
              <label for="">Minimum Order Amount</label><i class="text-danger asterik">*</i>
              <input type="number" class="form-control" name="minimum_order_amount" step="any">
            </div>
            <div class="form-group col-md-6">
              <label for="">Discount</label><i class="text-danger asterik">*</i>
              <input type="number" class="form-control" name="discount" id="discount" step="any">
            </div>
            <div class="form-group col-md-6">
              <label for="">Discount Type</label><i class="text-danger asterik">*</i>
            ...
            <div class="form-group col-md-6">
              <label for="">Max Discount Amount</label><i class="text-danger asterik">*</i>
              <input type="text" class="form-control" name="max_discount_amount" id="max_discount_amount">
            </div>
            <div class="form-group col-md-6">
              <label for="">Repeat Usage</label><i class="text-danger asterik">*</i>
