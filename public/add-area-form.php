                ...
                <form method="post" id="area_form" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Pincode :</label><i class="text-danger asterik">*</i><?php echo isset($error['pincode_ID']) ? $error['pincode_ID'] : ''; ?>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">City :</label><i class="text-danger asterik">*</i><?php echo isset($error['city_id']) ? $error['city_id'] : ''; ?>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Area Name</label><i class="text-danger asterik">*</i><?php echo isset($error['area_name']) ? $error['area_name'] : ''; ?>
                            <input type="text" class="form-control" name="area_name" id="area_name" required />
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Minimum Free Delivery Order Amount</label><i class="text-danger asterik">*</i><?php echo isset($error['minimum_free_delivery_order_amount']) ? $error['minimum_free_delivery_order_amount'] : ''; ?>
