                    ...
                    <form method="post" id="add_form" action="public/db-operation.php" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        <label for="">Commission (%) <small>[Will be used if category wise commission not set] <a href="#" data-toggle='modal' data-target='#howItWorksModal' title='How it works'>How seller commission works?</a></label><i class="text-danger asterik">*</i></small>
