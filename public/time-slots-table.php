      ...
      <div class="box box-primary">
        ...
        <form method="post" id="add_form" action="public/db-operation.php">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="">From Time <small>(24 hrs format)</small></label><i class="text-danger asterik">*</i>
              <input type="time" class="form-control" name="from_time">
            </div>
            <div class="form-group">
              <label for="">To Time <small>(24 hrs format)</small></label><i class="text-danger asterik">*</i>
              <input type="time" class="form-control" name="to_time">
            </div>
            <div class="form-group">
              <label for="">Last Order Time <small>(24 hrs format)</small></label><i class="text-danger asterik">*</i>
