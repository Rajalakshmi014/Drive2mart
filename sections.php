                        ...
                        <form id="section_form" method="post" action="api-firebase/sections.php" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for='title'>Title for section</label><i class="text-danger asterik">*</i>
                                    <input type='text' name='title' id='title' class='form-control' placeholder='Ex : Featured Products / Products on Sale' required />
                                </div>
                                <div class="form-group">
                                    <label for='short_description'>Short Description</label><i class="text-danger asterik">*</i>
                                ...
                                <div class="form-group">
                                    <label for='product_ids'>Product IDs <small>( Ex : 100,205, 360 <comma separated>)</small></label><i class="text-danger asterik">*</i>
                                ...
                                <div class="form-group">
                                    <label for='category_ids'>Category IDs <small>( Ex : 100,205, 360 <comma separated>)</small></label><i class="text-danger asterik">*</i>
                                    <select name='category_ids[]' id='category_ids' class='form-control' placeholder='Enter the Category IDs you want to display specially on home screen of the APP in CSV formate' required multiple="multiple">
